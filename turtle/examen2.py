...
serpiente.penup()
serpiente.goto(0,0)
serpiente.direction = "up" #modify this one
...
while True:
    ...
    if serpiente.xcor() > 300 or serpiente.xcor() < -300 or serpiente.ycor() > 300 or serpiente.ycor() < -300:
        ...
        cuenta = 0
        texto.clear()
        texto.write("Marcador:{}\tMarcador más alto: {}".format(cuenta,cuenta_alto), align="center",font=("verdana",24,"normal"))
